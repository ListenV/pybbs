                ...
                <div class="media-body">
                    <div class="gray" <#if !notification.read>style="font-weight:700;"</#if>>
                        ...
                        <#if notification.action == "COMMENT">
                            评论了你的文章 <a href="/topic/${notification.topicId}">${notification.title}</a>
                        <#elseif notification.action == "REPLY">
                            在文章 <a href="/topic/${notification.topicId}">${notification.title}</a> 下回复了你
                        <#elseif notification.action == "COLLECT">
                            收藏了你的文章 <a href="/topic/${notification.topicId}">${notification.title}</a>
                        </#if>
                    </div>
